...
namespace
{
    ...
    bool GetInternetDateTime()
    {
        ...
        Serial.print("20"+String(internetDateTime.Year) + "-" + String(internetDateTime.Month) + "-" + String(internetDateTime.Date) + " ");
        Serial.println(String(internetDateTime.Hour) + ":" + String(internetDateTime.Minute) + ":" + String(internetDateTime.Second));
...
namespace RealTimeClock
{
    ...
    void RealTimeClock::Initialise()
    {
        ...
        m_daylightSavingsTime = (bool) m_RTC.Read_EEPROM(0x00);
